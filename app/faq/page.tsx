...
function Page() {
  return (
    <section className="relative max-w-3xl mx-auto py-16 px-4 min-h-[80vh]">
      {/* Decorative shapes */}
      <Image
        ...
        width={180}
        height={180}
        className="absolute -top-10 -left-10 opacity-20 pointer-events-none select-none"
        aria-hidden="true"
      />
      <Image
      ...
      <div className="mt-12 text-center">
        <p className="mb-2 text-lg">Masih butuh bantuan?</p>
        <a
          href="mailto:help@layanify.ai"
          className="inline-block px-6 py-2 bg-primary text-white rounded-md font-medium shadow hover:bg-primary/90 transition"
        >
          Hubungi kami di help@layanify.ai
        </a>
      </div>
    </section>
  );
